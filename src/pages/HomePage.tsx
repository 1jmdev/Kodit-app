        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6 pb-32">
            <div className="w-full max-w-2xl space-y-6">
                            ...
                            <DropdownMenuTrigger
                                render={
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        className="gap-2 min-w-[200px] justify-between text-sm"
                                    >
                ...
                <PromptInput
                    variant="home"
                    pendingProject={
                        selectedProjectId === null ? pendingProject : null
                    }
                ...
                <div className="flex items-center justify-center gap-4 text-xs text-muted-foreground/50">
                    <span>
                        Press{" "}
                        <kbd className="rounded border border-border/50 px-1.5 py-0.5 text-[10px] font-mono bg-muted/30">
                            Enter
                        </kbd>{" "}
                        to send
                    </span>
