...
import { handleKeyboardClick, handlePrimaryMouseDown } from "@/components/sidebar/sidebar-utils";
  ...
  return (
    <div className="flex h-full w-[260px] flex-col bg-sidebar select-none rounded-tr-[24px]">
      ...
      <div className="flex items-center justify-between px-4 py-1.5">
        <span className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/70">Threads</span>
      </div>
      ...
      <ProjectThreadsSection
        ...
        navigate={navigate}
        onSelectProject={(projectId) => dispatch({ type: "SET_ACTIVE_PROJECT", projectId })}
        onPrimaryMouseDown={handlePrimaryMouseDown}
        onKeyboardClick={handleKeyboardClick}
