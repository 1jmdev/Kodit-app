        ...
        >
            ...
            <div className="flex items-center gap-1.5">
                    ...
                    <DropdownMenuTrigger
                        render={
                            <Button
                                variant="outline"
                                size="sm"
                                className="gap-1.5 h-7 text-xs font-medium px-2.5"
                            >
                ...
                {activeThread.totalAdditions > 0 && (
                    <Badge
                        variant="outline"
                        className="font-mono text-[10px] gap-1 px-2 h-7 border-border/50 rounded-md"
                    >
                        <span className="text-emerald-400">
                            +{activeThread.totalAdditions}
                        </span>
                        <span className="text-red-400">
                            -{activeThread.totalDeletions}
                        </span>
                    </Badge>
                )}
