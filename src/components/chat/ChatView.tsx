    ...
    return (
        <div className="flex items-center gap-2 py-1 text-sm text-muted-foreground">
            <div className="flex items-center gap-1.5">
                ...
                ) : toolCall.name.startsWith("Updated TODO") ||
                  toolCall.name.startsWith("Read TODO") ? (
...
const FileEditSummary = memo(function FileEditSummary({
    edits,
}: {
    edits: FileEdit[];
}) {
            ...
            >
                ...
                >
                    ...
                    {message.isStreaming && !isUser && (
                        <span className="inline-block h-4 w-1 animate-pulse rounded-sm bg-foreground/70 align-middle" />
                    )}
                </div>
