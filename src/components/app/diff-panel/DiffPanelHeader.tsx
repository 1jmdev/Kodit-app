    ...
    <div className="border-b border-border/50 px-4 py-2.5">
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-2">
          <span className="truncate text-xs font-medium text-foreground/85">Tracked changes</span>
        ...
        <div className="flex items-center gap-2 text-xs font-mono">
          <span className={cn("text-emerald-500 dark:text-emerald-400", additions === 0 && "opacity-50")}>
            +{additions}
          </span>
          <span className={cn("text-red-500 dark:text-red-400", deletions === 0 && "opacity-50")}>
            -{deletions}
          </span>
        </div>
      </div>
