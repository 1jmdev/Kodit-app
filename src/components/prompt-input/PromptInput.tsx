...
export function PromptInput({
    ...
    const modelProfiles =
        state.settings.modelProfiles.length > 0
            ? state.settings.modelProfiles
            : [state.selectedModel];
    const { pendingQuestions, isWaitingForAnswer, submitAnswers } =
        usePendingQuestions();
            ...
            >
                ...
                <div className="flex items-center justify-between px-2.5 pb-2.5">
                    ...
                    <Button
                        ...
                        disabled={
                            (!input.trim() && !isWaitingForAnswer) ||
                            (isGenerating && !isWaitingForAnswer)
                        }
                        className={cn(
